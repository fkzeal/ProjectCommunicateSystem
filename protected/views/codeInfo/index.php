...
<!--<head>
    ...
    <script type="text/javascript" src="CodeInfoFiles/js/Info.js"></script>
</head>-->
...
<!--                        <li>评分：<span id="item-grade"><?php echo $project->projectCodes['CodeScore']; ?></span></li>-->
                    ...
                    <li>下载次数：<span><?php echo $project->projectCodes['CodeDownloadTimes']; ?>次</span></li>
                ...
                <hr>
                <?php $downloadUrl = Yii::app()->createUrl('site/download', array(
                        )) ?>
                <form id="download" name="download" method="post" action="<?php echo $downloadUrl; ?>" >
                    ...
                    <button type="submit" class="btn btn-primary">下载源码</button>  
                </form>
                ...
                <div class="row">
                    <div class="span10">
                        ...
                        <ul class="nav nav-tabs">									
                            ...
                            <li>
                                <a data-toggle="tab" href="#tab-code-detail"><span class="label label-info"><i class="icon-pencil"></i>源码简介</span></a>
                            </li>
                            <!--	<li>
                                                    <a data-toggle="tab" href="#tab-rellink"><span class="label label-info"><i class="icon-share"></i>参考链接</span></a>
                                            </li>  -->
                            <li>
                                <a data-toggle="tab" href="#tab-code-preview"><span class="label label-info"><i class="icon-list"></i>代码预览</span></a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content">
                            ...
                            <!--tab code detail-->
                            <div class="tab-pane" id="tab-rellink">
                                <div id="code-rellink" class="code-detail-box">
                                    <p>
                                        <a href="">www.dkjl.com</a><br/>
                                        <a href="">kjoiel.com</a><br/>
                                        <a href="">dsdf.com</a><br/>
                                    </p>
                                </div>  
                            </div>
                            <!--tab code preview-->
                                    ...
                                    <form id="code-comment" action="<?php echo yii::app()->createUrl('codeinfo/comment'); ?>" 
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group docs-input-sizes">
                                                <!--                                                        <div class="controls">
                                                                                                            <textarea id="comment-content" name="comment-content" rows="10" cols="150" class="span8">
                                                                                                            </textarea>  
                                                                                                        </div>											            -->
                                                <div class="controls">
