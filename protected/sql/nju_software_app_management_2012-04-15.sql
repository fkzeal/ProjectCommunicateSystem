...
# Dumping data for table nju_software_app_management.project: ~9 rows (approximately)
DELETE FROM `project`;
/*!40000 ALTER TABLE `project` DISABLE KEYS */;
INSERT INTO `project` (`ID`, `ProjectName`, `ProjectStatus`, `TeamName`, `ProjectSummary`, `ProjectDescription`, `ProjectCreatedTime`, `ProjectIconPath`, `UserID`) VALUES
	(4, 'renren', 0, '无', 'asf', 'renren', '2012-02-23 10:50:14', '', 1),
	(5, 'facebook', 0, '无', 'asdf', 'facebook', '2012-02-23 10:52:52', '', 1),
	(6, 'renre', 0, '无', 'asdf', 'renren', '2012-02-28 21:37:53', '', 1),
	(7, 'rwer', 0, '无', 'asdf', '是dvd双方的分别\n', '2012-02-28 21:38:28', '', 1),
	(8, '发顺丰', 0, '无', 'asdf', 'renren是dvd双方的分别\n是dvd双方的分别\n是dvd双方的分别\n\n', '2012-02-28 21:38:37', '', 1),
	(27, '你好', 0, '无团队名', 'asdf', '<p>阿斯顿发斯蒂芬asdfsadf</p>', '2012-04-04 17:50:44', 'Icon\\27\\你好.jpg', 21),
	(28, 'hellow_world', 0, '无团队名', 'good_project', '<p>asdfasfdasfdasdfasdfasdf</p>', '2012-04-15 19:45:28', 'Icon\\28\\hellow_world.jpg', 21),
	(29, 'asfd', 0, '无团队名', 'asdf', '<p>asdf</p>', '2012-04-15 19:48:20', 'Icon\\29\\asfd.jpg', 21),
	(30, 'asdf', 0, '无团队名', 'asdf', '<p>asdf</p>', '2012-04-15 20:04:51', 'Icon\\30\\asdf.jpg', 21);
...
# Dumping data for table nju_software_app_management.project_app: ~9 rows (approximately)
...
# Dumping data for table nju_software_app_management.project_code: ~9 rows (approximately)
...
INSERT INTO `project_code` (`ID`, `ProjectID`, `CodeScore`, `CodeDownloadTimes`, `CodeDescription`, `CategoryID`, `CodeFragment`) VALUES
	...
	(27, 28, 0, 0, '<p>asdfasdfasdf</p>', 16, '<p>asdfasdfasdf</p>'),
	(28, 29, 0, 0, '<p>asdfasdf</p>', 11, '<p>asdfasdfasdf</p>'),
	(29, 30, 0, 0, '<p>asdf</p>', 11, '<p>asdf</p>');
...
# Dumping data for table nju_software_app_management.project_comment: ~1 rows (approximately)
